...
# ###############################
# readme <- readtext('F:/Miscellaneous/Hydro_classes/Map/Map_9/www/README.txt')
# metadata <- read.csv('F:/Miscellaneous/Hydro_classes/Map/Map_9/www/metadata_columns.csv')
# 
# readme_gages <- readtext('F:/Miscellaneous/Hydro_classes/Map/Map_9/www/README_gages.txt')
# metadata_gages <- read.csv('F:/Miscellaneous/Hydro_classes/Map/Map_9/www/metadata_columns_gages.csv')
# 
# rm(fc) 
# rm(all.Lines)
# rm(polys)
# save.image("F:/Miscellaneous/Hydro_classes/Map/Map_9/Map_9.RData")
